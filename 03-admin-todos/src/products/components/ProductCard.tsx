    ...
    return (
        <div className="shadow rounded-lg max-w-sm bg-gray-800 border-gray-100">
            ...
            <div className="px-5 pb-5">
                <a href="#">
                    <h3 className="text-gray-900 font-semibold text-xl tracking-tight text-white">{name}</h3>
                </a>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-gray-900 text-white">${price.toFixed(2)}</span>
